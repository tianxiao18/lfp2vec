...
def run_wave2vec2(sessions, sess, sampling_rate, acronyms_arr):
    ...
    labels = [example['label'] for example in dataset_dict["train"]]
    ...
    def compute_metrics(eval_pred):
        ...
        metrics["experiment_id"] = random_string
        return metrics
...
if __name__ == "__main__":
    if data == "Allen":
        ...
        sessions_list = ['0802ced5-33a3-405e-8336-b65ebc5cb07c_probe00',
                        ...
                        #  '30c4e2ab-dffc-499d-aae4-e51d6b3218c2_probe00',
                        #  'ff96bfe1-d925-4553-94b5-bf8297adf259_probe01']
