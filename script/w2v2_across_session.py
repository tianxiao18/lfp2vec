...
def visualize_signal(features, trials, trial_idx=0, channel_idx=100):
    trial_mask = trials == trial_idx
    raw_signal_lfp = features[trial_mask]
    plt.figure(figsize=(12, 3))
    plt.plot(raw_signal_lfp[channel_idx])
...
def run_wave2vec2(sessions, sess, sampling_rate):
    ...
    features, labels, trials = load_preprocessed_data(pickle_path, file_path, data_type)
    features = features.get(file_path[0])
    labels = labels.get(file_path[0])
    trials = trials.get(file_path[0])
    # visualize_signal(features, trials)
...
if __name__ == "__main__":
    if data == "Allen":
        ...
        sessions_list = ['5b49aca6-a6f4-4075-931a-617ad64c219c_probe01', '73918ae1-e4fd-4c18-b132-00cb555b1ad2_probe00', '73918ae1-e4fd-4c18-b132-00cb555b1ad2_probe01']
        pickle_path = f'/scratch/cl7201/region_decoding/data/ibl/updated/preprocessed'
        hc_acronyms = {'CA1', 'CA2', 'CA3', 'DG', 'VIS'}
