...
def run_pipeline(sessions, session_config, sweep_config, i):
    ...
    run = wandb.init(project="vit_encoder", name=f"{sessions[i]}_{group}_decoder_run",group=group, config=sweep_config, reinit=True)
